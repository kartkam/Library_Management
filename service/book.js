  ...
  async.parallel(
    {
      book_count: function (callback) {
        Book.count().then(function (bookCount) {
          callback(null, bookCount);
        });
      },
      book_instance_count: function (callback) {
        BookInstance.count().then(function (bookInstanceCount) {
      ...
      genre_count: function (callback) {
        Genre.count().then(function (genreCount) {
          callback(null, genreCount);
        });
      },
      author_count: function (callback) {
        Author.count().then(function (authorCount) {
    ...
    include: [
      {
        model: Author,
        as: "author_details",
        attributes: ["first_name", "family_name", "name"],
      },
    ],
  })
